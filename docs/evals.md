...
| ------ | -------------- | ---- |
| 1 | [34031313764](https://github.com/pathlyapp/opensteerable/actions/runs/34031313764) | 0.7865 (70/89) |
| 2 | [34031319806](https://github.com/pathlyapp/opensteerable/actions/runs/34031319806) | 0.7978 (71/89) |
| 3 | [34040053173](https://github.com/pathlyapp/opensteerable/actions/runs/34040053173) | 0.8652 (77/89) |
| 4 | [34122470060](https://github.com/pathlyapp/opensteerable/actions/runs/34122470060) | 0.7978 (71/89) |
| 5 | [34122485974](https://github.com/pathlyapp/opensteerable/actions/runs/34122485974) | 0.7978 (71/89) |
| 6 | [34139665379](https://github.com/pathlyapp/opensteerable/actions/runs/34139665379) | 0.7978 (71/89) |
...
Superseded: four runs at `27d521a` posted mean 0.8006 (73/70/73/69; GHA [33497477757](https://github.com/pathlyapp/opensteerable/actions/runs/33497477757), [33530806570](https://github.com/pathlyapp/opensteerable/actions/runs/33530806570), [33530856872](https://github.com/pathlyapp/opensteerable/actions/runs/33530856872), [33547943349](https://github.com/pathlyapp/opensteerable/actions/runs/33547943349)). A fifth run on the pre-`8e260de` tree ([34019591179](https://github.com/pathlyapp/opensteerable/actions/runs/34019591179)) is excluded: OpenRouter credit exhaustion mid-run (HTTP 402) truncated 45 of 89 trials, and its 36/89 measures the wallet, not the harness.

**Pi + GLM-5.3-Flash = 73%** across three catalog runs, mean **0.7336**, SD **0.0222**:

| Sample | GitHub Actions | Mean |
| ------ | -------------- | ---- |
| 1 | [33593245247](https://github.com/pathlyapp/opensteerable/actions/runs/33593245247) | 0.7528 (67/89) |
| 2 | [33712341301](https://github.com/pathlyapp/opensteerable/actions/runs/33712341301) | 0.7093 (61/86) |
| 3 | [33712363232](https://github.com/pathlyapp/opensteerable/actions/runs/33712363232) | 0.7386 (65/88) |
...
Claude Code on the same model and protocol: **83.1% (74/89), 1 run**. Catalog shards: GHA [33798916303](https://github.com/pathlyapp/opensteerable/actions/runs/33798916303); fill-in [33833495592](https://github.com/pathlyapp/opensteerable/actions/runs/33833495592). Recipe: `evals/README.md` (`--agent claude-code-glm`, CLI 2.1.259). Per-task set vs steerable sample 1: `evals/notes/claude-code-glm-task-diff.md`.
...
Arm history on the road to `8e260de`. Flaky A/B of the `20a854d` verify gate is done: GHA [33951133679](https://github.com/pathlyapp/opensteerable/actions/runs/33951133679) (`STEERABLE_DELIVERY_VERIFY=0` on B). 20 paired tasks, p=0.7539, CI includes 0 — **no separation; keep the gate on**. The only gate-fire-then-fail is `extract-elf` (old retry copy, already fixed on HEAD). ReminderHooks A/B is done: GHA [33959644133](https://github.com/pathlyapp/opensteerable/actions/runs/33959644133) (`STEERABLE_REMINDERS=1` on B). 20 paired, p=0.3438, CI includes 0; `make-mips-interpreter` A 2/3 vs B 1/3 — **keep reminders off**. Wrap-up livelock A/B is done: GHA [33966115606](https://github.com/pathlyapp/opensteerable/actions/runs/33966115606) (`STEERABLE_LIVELOCK_EMPTY_STREAK=3` on B). 19 paired, p=1.0, CI includes 0; 4 B fires, 0 conversion — **keep livelock off**. Spiral-red [33966527336](https://github.com/pathlyapp/opensteerable/actions/runs/33966527336): `regex-chess` 0/3 with a fire on every trial. Ignore [33964691558](https://github.com/pathlyapp/opensteerable/actions/runs/33964691558) (402). Left-tail stack is `de45915` plus helper-script git rewrite, wrap-up generator writes, and git-leak prune allow (`4746d14`): Harbor env-start retry, git-history bash gate (command **or** invoked helper; allow `rewriting history` / recover-then-purge so `git-leak-recovery` can still `gc --prune`), named `.txt` stub/prefix/raster, wrap-up shown-text + inspect-block of dump reads and helper rewrite, wrap-up prefix/stub, wrap-up re-asserts `tool_choice=required` while those gates fail, wrap-up instruction-example (compile sibling `.c`; `cat > gen.py` and `python3 gen.py` that writes the named file still run), pre-wrap livelock detector (default still 0), `ChainHooks` retry-over-narrate. Arm 3b is done: GHA [33976774219](https://github.com/pathlyapp/opensteerable/actions/runs/33976774219) (`STEERABLE_LIVELOCK_EMPTY_STREAK=3` on B, SHA `de45915`). 20 paired, p=1.0000, CI includes 0; mechanism `circuit-fibsqrt` A 3/3 vs B 2/3 with 7 B fires and 6 reward-0 — **keep livelock off**. Native image-read A/B is done: GHA [33985962466](https://github.com/pathlyapp/opensteerable/actions/runs/33985962466) (`STEERABLE_READ_IMAGES=1` on B, SHA `ea81b77`). 20 paired, p=0.0225, CI excludes 0, A wins (mean −0.20); `code-from-image` tied 3/3 — **keep ASCII**. self_critique A/B is done: GHA [34003963766](https://github.com/pathlyapp/opensteerable/actions/runs/34003963766) (`STEERABLE_HARNESS=evals/harnesses/self_critique.harness.yaml` on B, SHA `7ad0b26` with the TB instruction wired as `user_question`). 20 paired, p=1.0000, CI includes 0 (A 39/60 vs B 40/60); both 3h-cancelled shards were arm B — **keep self_critique off**. CC-align prompt A/B is done: GHA [34011962039](https://github.com/pathlyapp/opensteerable/actions/runs/34011962039) (`STEERABLE_PROMPT_CC_ALIGN=1` on B, SHA `81f682d`). 20 paired, p=0.5078, CI includes 0; arm A swung 39/60→30/60 between runs on identical default code — **keep CC-align off**. Reasoning-effort A/B is done: spiral-red GHA [34040196148](https://github.com/pathlyapp/opensteerable/actions/runs/34040196148) (`STEERABLE_REASONING_EFFORT=high`, SHA `8e260de`) went 0/9 — no unlock; flaky paired GHA [34040202706](https://github.com/pathlyapp/opensteerable/actions/runs/34040202706), p=0.4240, CI includes 0, mean −0.05 — **keep `max`**. The flaky arm queue is empty. Remaining arms: `evals/notes/ab-arms.md`.
...
Do not run all 89 on every PR. SWE-bench Verified is the next public standard **after** the product agent has a Terminal-Bench Harbor score; run the full Verified set, never a homemade 20-task subset. Work order: [`EVALS_TODO.md`](https://github.com/pathlyapp/opensteerable/blob/main/EVALS_TODO.md).
