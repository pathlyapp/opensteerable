...
- [`examples/py-minimal/`](https://github.com/pathlyapp/opensteerable/tree/main/examples/py-minimal) — Python protocol + harness + tool dispatch
- [`examples/ts-minimal/`](https://github.com/pathlyapp/opensteerable/tree/main/examples/ts-minimal) — TypeScript protocol consumer
- [`examples/sidecar-roundtrip/`](https://github.com/pathlyapp/opensteerable/tree/main/examples/sidecar-roundtrip) — Spawn sidecar, run a chat-stream end-to-end
