...
describe('isGuiLaunchCommand', () => {
  it('matches standalone "gui" tokens in DomainTool-style launch commands', () => {
    expect(isGuiLaunchCommand('DomainToolNet.exe gui replay card.xml')).toBe(true);
    expect(isGuiLaunchCommand('"C:\\Program Files\\DomainTool\\app.exe" gui')).toBe(true);
